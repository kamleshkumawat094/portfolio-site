...
const Navbar = ({ onProjectsClick }) => {
  ...
  return (
    <div className="sticky flex flex-row place-content-between ">
      <h1 className="text-4xl font-bold slide-in-left duration-1 cursor-pointer ">
      ...
      <ul className="hidden md:flex flex-row lg:gap-15 gap-5 items-end text-[18px]">
        <li className="slide-in-left duration-2 ">
          <button
            className="cursor-pointer center-underline text-[#00AEFF]"
      ...
      <button className=" hidden md:flex items-end slide-in-left duration-5 border  rounded py-2 px-3 bg-[#ed3393] font-bold cursor-pointer">
        <a href="https://drive.usercontent.google.com/u/0/uc?id=1ALa81CJxrlbq9H_ZPpZq3KYcwCKvJJTA&export=download">Download CV </a>
      </button>
      ...
      />
          ...
          <motion.div className=" md:hidden absolute top-8 bg-black mt-7 p-1 z-50 w-[calc(100%-2.5rem)] mx-[20px] rounded-2xl" onClick={(e) => e.stopPropagation()}
